...
use App\Controllers\NoveltyController;
...
return static function (Router $router): void {
    ...
    $router->post('/novedades/registro', [NoveltyController::class, 'store']);
    $router->get('/novedades/supervision', [NoveltyController::class, 'supervision']);
    $router->post('/novedades/anular', [NoveltyController::class, 'annul']);
    $router->get('/novedades/mis-novedades', [NoveltyController::class, 'own']);
    $router->get('/novedades/representante', [NoveltyController::class, 'representative']);
    $router->get('/comunicados', [CommunicationController::class, 'index']);
    $router->get('/comunicados/nuevo', [CommunicationController::class, 'create']);
    $router->get('/comunicados/editar', [CommunicationController::class, 'edit']);
    $router->get('/comunicados/ver', [CommunicationController::class, 'show']);
    $router->get('/comunicados/buscar-estudiantes', [CommunicationController::class, 'searchStudents']);
    $router->get('/comunicados/buscar-representantes', [CommunicationController::class, 'searchRepresentatives']);
    $router->get('/comunicados/buscar-personal', [CommunicationController::class, 'searchStaff']);
    $router->post('/comunicados', [CommunicationController::class, 'store']);
    $router->post('/comunicados/anular', [CommunicationController::class, 'annul']);
    $router->post('/comunicados/eliminar', [CommunicationController::class, 'delete']);
    $router->get('/mis-comunicados', [CommunicationController::class, 'mine']);
    $router->get('/mis-comunicados/leer', [CommunicationController::class, 'read']);
    ...
    $router->get('/configuracion/backups', [BackupController::class, 'index']);
    $router->get('/configuracion/backups/descargar', [BackupController::class, 'download']);
    ...
    $router->post('/configuracion/contable/servicios', [ConfigurationController::class, 'saveAccountingModuleSettings']);
    $router->post('/configuracion/backups', [BackupController::class, 'create']);
    $router->post('/configuracion/backups/eliminar', [BackupController::class, 'delete']);
    ...
    $router->post('/contabilidad/pagos/reversar', [AccountingController::class, 'reversePayment']);
    ...
    $router->post('/configuracion/academica/calificaciones/perfil/grupos-materias', [ConfigurationController::class, 'updateGradeProfileSubjectGroups']);
    ...
    $router->get('/personal/registro/persona', [PersonalController::class, 'findPerson']);
    ...
    $router->get('/matriculas/certificado', [MatriculationController::class, 'certificatePdf']);
    $router->get('/matriculas/reporte/pdf', [MatriculationController::class, 'reportPdf']);
