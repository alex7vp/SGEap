...
<section class="security-assignment-block" id="representantes-habilitacion">
    ...
    <?php else: ?>
        <div class="toolbar toolbar-filter">
            <div class="filter-box">
                <label class="sr-only" for="representative-authorization-search">Buscar representante activo</label>
                <input
                    id="representative-authorization-search"
                    type="search"
                    placeholder="Buscar representante activo por cedula, nombres, apellidos o usuario"
                    data-representative-authorization-search
                    data-representative-authorization-search-url="<?= htmlspecialchars(baseUrl('seguridad/representantes/matricula-nueva/buscar'), ENT_QUOTES, 'UTF-8'); ?>"
                    autocomplete="off"
                >
            </div>
            <span class="filter-status" data-representative-authorization-status>Escriba al menos 2 caracteres</span>
        </div>

        <div class="table-wrap temporary-users-table-wrap" data-representative-authorization-table-wrapper hidden>
            <table class="data-table security-table temporary-users-table">
                ...
                <tbody data-representative-authorization-table-body>
                    <?php require BASE_PATH . '/app/views/seguridad/_representative_authorization_rows.php'; ?>
                </tbody>
            </table>
        </div>
        <div data-representative-authorization-empty-wrapper>
            <div class="empty-state">Escriba al menos 2 caracteres para buscar representantes activos.</div>
        </div>
    <?php endif; ?>
</section>
