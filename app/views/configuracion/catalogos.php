...
?>
<div class="toolbar">
    <p>Visualizacion de catalogos base usados por matriculacion, personas y otros modulos del sistema.</p>
</div>
                        ...
                        <tr class="catalog-create-row">
                            ...
                            <td colspan="2">
                                <form class="catalog-inline-form catalog-inline-create" method="POST" action="<?= htmlspecialchars(baseUrl('configuracion/catalogos'), ENT_QUOTES, 'UTF-8'); ?>">
                                    ...
                                    <button class="btn-primary btn-auto" type="submit">Guardar</button>
                                </form>
                            </td>
                        </tr>
                    </tbody>
