...
abstract class Controller
{
    ...
    private function permissionForCurrentPath(string $path): ?string
    {
        ...
        $exact = [
            ...
            '/calificaciones/registro' => 'asistencia.registrar|calificaciones.registrar|calificaciones.configurar',
            '/calificaciones/actividad' => 'asistencia.registrar|calificaciones.registrar|calificaciones.configurar',
            '/calificaciones/notas' => 'asistencia.registrar|calificaciones.registrar|calificaciones.configurar',
            ...
            '/reportes/cuadro-final' => 'calificaciones.validar|calificaciones.configurar|calificaciones.registrar',
