...
abstract class Controller
{
    ...
    private function permissionForCurrentPath(string $path): ?string
    {
        ...
        $exact = [
            ...
            '/mis-comunicados' => 'comunicados.ver_propios|comunicados.gestionar|representante.estudiantes',
            '/mis-comunicados/leer' => 'comunicados.ver_propios|comunicados.gestionar|representante.estudiantes',
