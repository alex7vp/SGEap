...
abstract class Controller
{
    ...
    private function permissionForCurrentPath(string $path): ?string
    {
        ...
        $exact = [
            ...
            '/asistencia' => 'asistencia.calendario.gestionar|asistencia.registrar|asistencia.supervisar|justificaciones.gestionar|asistencia.ver_propia|asistencia.representante.ver',
            ...
            '/asistencia/mi-asistencia' => 'asistencia.ver_propia',
            '/asistencia/representante' => 'asistencia.representante.ver',
